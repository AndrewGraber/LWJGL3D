package com.anzanama.lwjgl3d.Game.World.Terrain;
...
public class Terrain {
    ...
    public Terrain(ModelLoader loader, TerrainTexturePack texturePack, TerrainTexture blendMap, String heightMap) {
    ...
    private RawModel generateTerrain(ModelLoader loader, String heightMap){
        ...
        try {
            image = ImageIO.read(new File("src/main/resources/textures/terrain/height_maps/" + heightMap + ".png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
